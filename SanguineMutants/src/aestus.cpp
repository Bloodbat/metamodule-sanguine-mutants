...
struct Aestus : SanguineModule {
	...
	void process(const ProcessArgs& args) override {
		...
		bSheep = static_cast<bool>(std::round(params[PARAM_MODEL].getValue()));

		bool bSync = static_cast<bool>(std::round(params[PARAM_SYNC].getValue())) || (!bSheep && inputs[INPUT_CLOCK].isConnected());
